...
//    }
     ...
     */
    public static Troop makeTroop(String type , int level , Point2D point2D , String owner , ImageView base , ImageView head){
        ...
        {
            return new SoldierCard(typeParam,5,level == 1 ? 75 : level == 2 ? 82 : level == 3? 90 : level == 4 ? 99 : 109
        ...
        {
            return new SoldierCard(typeParam,3,level == 1 ? 33 : level == 2 ? 44 : level == 3? 48 : level == 4 ? 53 : 58
        ...
        {
            return new SoldierCard(typeParam,4,level == 1 ? 100 : level == 2 ? 110 : level == 3? 121 : level == 4 ? 133 : 146
        ...
        {
            return new SoldierCard(CardTypes.WIZARD,5,level == 1 ? 130 : level == 2 ? 143 : level == 3? 157 : level == 4 ? 172 : 189
        ...
        {
            return new SoldierCard(CardTypes.MINI_PEKKA,4,level == 1 ? 325 : level == 2 ? 357 : level == 3? 393 : level == 4 ? 432 : 474
        ...
        {
            return new SoldierCard(CardTypes.GIANT,5,level == 1 ? 126 : level == 2 ? 138 : level == 3? 152 : level == 4 ? 167 : 183
        ...
        {
            return new SoldierCard(typeParam,4,level == 1 ? 120 : level == 2 ? 132 : level == 3? 145 : level == 4 ? 159 : 175
        ...
        {
            return new SpellCard(typeParam,3,0 // doesn't have damage
                    ,level,"client_side/view/pics/rage.png","client_side/view/pics/rage.png", // attack frame and card frame are same
        ...
        {
            return new SpellCard(typeParam,4,level == 1 ? 325 : level == 2 ? 357 : level == 3? 393 : level == 4 ? 432 : 474
        ...
        {
            return new SpellCard(typeParam,3,level == 1 ? 144 : level == 2 ? 156 : level == 3? 174 : level == 4 ? 189 : 210
        ...
        {
            return new BuildingCard(typeParam,6,level == 1 ? 60 : level == 2 ? 66 : level == 3? 72 : level == 4 ? 79 : 87
        ...
        {
            return new BuildingCard(typeParam,5,level == 1 ? 400 : level == 2 ? 440 : level == 3? 484 : level == 4 ? 532 : 584
        ...
        {
            return new Tower(level == 1 ? 50 : level == 2 ? 53 : level == 3 ? 57 : level == 4 ? 60 : 64 ,
        ...
        {
            return new Tower(level == 1 ? 50 : level == 2 ? 54 : level == 3 ? 58 : level == 4 ? 62 : 69 ,
